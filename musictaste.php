...
$likes = array();
$like_query = "select artistid,aname,ltime from Likes natural join Artist where username='" . $_SESSION['username'] . "' order by ltime desc;";
...
$rates = array();
$rate_query = "select trackid,tracktitle,score,rtime from Rate natural join Track  where username='" . $_SESSION['username'] . "' order by rtime desc;";
...
$follow = array();
$follow_query = "select followee from Follow where follower = '" . $_SESSION['username'] . "';";
       ...
       <div class="demo-card-taste mdl-card mdl-shadow--2dp">
         <div class="mdl-card__title mdl-card--expand" >
           <h2 class="mdl-card__title-text">
              <?php 
                echo $_SESSION['username'] . "'s taste";
              ?>
           </h2>
         </div>
       </div>
