...
$get_playlist_meta = "select * from playlist where playlistid = ".$_GET['playlistid'].";";
$result = $conn->query($get_playlist_meta);
$playlist_meta = $result->fetch_assoc();
//console_log($playlist_meta);

$get_playlist_song = "select * from Pcontain natural join Track where playlistid = ". $_GET['playlistid']." order by porder;";
    ...
    <div class="mdl-cell mdl-cell--8-col">
      <div class="demo-card-play mdl-card mdl-shadow--2dp">
         <div class="mdl-card__title mdl-card--expand">
          ...
          <?php 
            echo $playlist_meta['playlisttitle'];
          ?>
          </h2>
         </div>
         <div class="mdl-card__supporting-text">
            ...
            <?php
              echo '<li class="mdl-list__item">
                      ...
                      <a target="_blank" href="user.php?username=' .
                      $playlist_meta['owner'].
                      '">' . 
                      $playlist_meta['owner'].
                      '</a>
